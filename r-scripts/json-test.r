...
nGramDict<-read_json('ignoredFiles/Sample-Dict/mixed-nGramDict_50_1.json')
...
input_t<-cleanInputPredict('hello this is 12 Donald trump!   ' )
input_t[(length(input_t)-nGramDict[['_model']]+2):length(input_t)]
